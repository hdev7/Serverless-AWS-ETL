...
default_url = "https://newyork.craigslist.org/search/apa?query={}&availabilityMode=0&sale_date=all+dates"
...
def get_rental_data(neighborhoods):
    ...
    # we need this json object in one line for athena (hive json serde)
